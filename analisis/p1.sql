...
INSERT INTO `empleado` VALUES (1,'Azael','334455'),(2,'Jose','224455'),(3,'Cris','009944'),(4,'Mario','220055');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `agregar_peli`(in compras int, in producto int, in cant int, in tot float, in fc date )
BEGIN

insert into compras (idcompras, idproducto, cantidad, total, fechacompra)
values(compras,producto,cant,tot,fc);
